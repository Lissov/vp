...
#Region "inputs"
    ...
    'p from i+1 part
    Public P_Output As New ModelBase.Value("P_Output", "Model_LV: P_Output", Value.ValueType.Input)

    'q from i-1 part
    Public Q_Input As New ModelBase.Value("Q_Input", "Model_LV: Q_Input", Value.ValueType.Input)
...
#Region "outputs"
    ...
    Public dQ As New ModelBase.Value("dQ", "Model_LV: dQ", Value.ValueType.Output)
    Public dTs As New ModelBase.Value("dTs", "Model_LV: dTs", Value.ValueType.Output)
    Public dU As New ModelBase.Value("dU", "Model_LV: dU", Value.ValueType.Output)
    Public R As New ModelBase.Value("R", "Model_LV: R", Value.ValueType.Output)
    Public Ts As New ModelBase.Value("Ts", "Model_LV: Ts", Value.ValueType.Output)
    Public U As New ModelBase.Value("U", "Model_LV: U", Value.ValueType.Output)
    Public V As New ModelBase.Value("V", "Model_LV: V", Value.ValueType.Output)
    Public Q As New ModelBase.Value("Q", "Model_LV: Q", Value.ValueType.Output)
    Public P As New ModelBase.Value("P", "Model_LV: P", Value.ValueType.Output)
