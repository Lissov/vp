...
#Region "inputs"
    ...
    'p from i-1 part
    Public P_Input As New ModelBase.Value("P_Input", "Model_PS: P_Input", Value.ValueType.Input)

    'q from i-1 part
    Public Q_Input As New ModelBase.Value("Q_Input", "Model_PS: Q_Input", Value.ValueType.Input)
    ...
    Public Kps As New ModelBase.Value("Kps", "Model_PS: Kps", Value.ValueType.Input)
    Public FullF As New ModelBase.Value("FullF", "Model_PS: FullF", Value.ValueType.Input)

    'limfa
    Public Q_Limf As New ModelBase.Value("Q_Limf", "Q_Limf", Value.ValueType.Input)

#End Region

#Region "outputs"

    Public dQ As New ModelBase.Value("dQ", "Model_PS: dQ", Value.ValueType.Output)
    Public dTs As New ModelBase.Value("dTs", "Model_PS: dTs", Value.ValueType.Output)
    Public dU As New ModelBase.Value("dU", "Model_PS: dU", Value.ValueType.Output)
    Public R As New ModelBase.Value("R", "Model_PS: R", Value.ValueType.Output)
    Public Ts As New ModelBase.Value("Ts", "Model_PS: Ts", Value.ValueType.Output)
    Public U As New ModelBase.Value("U", "Model_PS: U", Value.ValueType.Output)
    Public V As New ModelBase.Value("V", "Model_PS: V", Value.ValueType.Output)
    Public Q As New ModelBase.Value("Q", "Model_PS: Q", Value.ValueType.Output)
    Public P As New ModelBase.Value("P", "Model_PS: P", Value.ValueType.Output)
...
#Region "Calculate"
    ...
    Public Overrides Sub Cycle()
        ...
        'calculating Q
        Q.Value(CurrentStep) = (Kps.Value(CurrentStep - 1) * P_Input.Value(CurrentStep - 1) * FullF.Value(CurrentStep - 1)) * k_Q.Value


        'calculating dQ 
        dQ.Value(CurrentStep) = Q_Input.Value(CurrentStep - 1) - Q.Value(CurrentStep - 1) + Q_Limf.Value(CurrentStep - 1)
