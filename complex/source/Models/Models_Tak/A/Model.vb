...
#Region "inputs"
    ...
    'p from i+1 part
    Public P_Output As New ModelBase.Value("P_Output", "Model_A: P_Output", Value.ValueType.Input)

    'q from i-1 part
    Public Q_Input As New ModelBase.Value("Q_Input", "Model_A: Q_Input", Value.ValueType.Input)
...
#Region "outputs"
    ...
    Public dQ As New ModelBase.Value("dQ", "Model_A: dQ", Value.ValueType.Output)
    Public dTs As New ModelBase.Value("dTs", "Model_A: dTs", Value.ValueType.Output)
    Public dU As New ModelBase.Value("dU", "Model_A: dU", Value.ValueType.Output)
    Public R As New ModelBase.Value("R", "Model_A: R", Value.ValueType.Output)
    Public Ts As New ModelBase.Value("Ts", "Model_A: Ts", Value.ValueType.Output)
    Public U As New ModelBase.Value("U", "Model_A: U", Value.ValueType.Output)
    Public V As New ModelBase.Value("V", "Model_A: V", Value.ValueType.Output)
    Public Q As New ModelBase.Value("Q", "Model_A: Q", Value.ValueType.Output)
    Public P As New ModelBase.Value("P", "Model_A: P", Value.ValueType.Output)
