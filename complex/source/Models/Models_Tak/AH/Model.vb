...
#Region "inputs"
    ...
    'p from i+1 part
    Public P_Output As New ModelBase.Value("P_Output", "Model_AH: P_Output", Value.ValueType.Input)

    'q from i-1 part
    Public Q_Input As New ModelBase.Value("Q_Input", "Model_AH: Q_Input", Value.ValueType.Input)
...
#Region "outputs"
    ...
    Public dQ As New ModelBase.Value("dQ", "Model_AH: dQ", Value.ValueType.Output)
    Public dTs As New ModelBase.Value("dTs", "Model_AH: dTs", Value.ValueType.Output)
    Public dU As New ModelBase.Value("dU", "Model_AH: dU", Value.ValueType.Output)
    Public R As New ModelBase.Value("R", "Model_AH: R", Value.ValueType.Output)
    Public Ts As New ModelBase.Value("Ts", "Model_AH: Ts", Value.ValueType.Output)
    Public U As New ModelBase.Value("U", "Model_AH: U", Value.ValueType.Output)
    Public V As New ModelBase.Value("V", "Model_AH: V", Value.ValueType.Output)
    Public Q As New ModelBase.Value("Q", "Model_AH: Q", Value.ValueType.Output)
    Public P As New ModelBase.Value("P", "Model_AH: P", Value.ValueType.Output)
